...
Miguel Citeli — 13:49
Oi
carla da beatriz 🐧 — 13:50
hellooo
daqui a pouco vou criar o servidor com as abinhas que citei
pra gente mandar coisa dos projetos lá
mas pode mandar o código
Miguel Citeli — 13:50
Tá bem!
Vê se você consegue ver
import textwrap
import re
import os
import json
...
message.txt
13 KB
O link do streamlit é esse: https://sistema-darcy-tat9upwhz8wskst4pkhfxl.streamlit.app/
carla da beatriz 🐧 — 14:05
pera aí
vou alterar algumas coisas e testa se resolveu, tá?
Miguel Citeli — 14:19
Beleza!
carla da beatriz 🐧 — 15:04
então
não mexi em tudo
vamos ver se as alterações que fiz trazem algum resultado primeiro
o que mudei foi: puxei as funções pra cima
troquei alguns prints por return
tipo
for bio in biografias:
        print(bio)
...
por 
    ...
    return "\n\n".join(biografias)
troquei outros prints por st.markdown
só alterei até a função do Caio
import textwrap
import re
import os
import json
...
ver1.txt
13 KB
testa se vai dar o mesmo erro ou erro diferente KKKKKK
Miguel Citeli — 15:48
Beleza, vou testar assim que o jogo do flu acabar kkkkk
Ele tava aceitando a busca, mas tava com problema nada hora de botar a história
E acho que não mostrou as outras coisas por conta desse problema anterior
﻿
